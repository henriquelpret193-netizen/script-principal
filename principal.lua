...
Top.BackgroundColor3 = _G.MenuColor
Top.Parent = Main
...
local function AddToggle(name, var, parent)
    ...
    l.BackgroundTransparency = 1; l.Font = Enum.Font.Code; l.TextSize = 12; l.TextXAlignment = Enum.TextXAlignment.Left; l.Parent = f
...
local function AddSlider(name, min, max, var, parent, spaceBefore)
    ...
    l.BackgroundTransparency = 1; l.Font = Enum.Font.Code; l.TextSize = 10; l.Parent = container
...
local function AddTargetSelector(parent)
    ...
    label.BackgroundTransparency = 1; label.Font = Enum.Font.Code; label.TextSize = 11; label.Parent = container
    ...
    for name, part in pairs(parts) do
        local b = Instance.new("TextButton"); b.Size = UDim2.new(0.45, 0, 0.8, 0); b.Position = UDim2.new(0.02 + (count * 0.48), 0, 0, 0); b.Text = name; b.Font = Enum.Font.Code; b.TextSize = 10; b.BorderSizePixel = 0; b.Parent = btnFrame
        buttons[name] = b
...
local function AddModeSelector(parent)
    ...
    for _, mode in pairs(modes) do
        local b = Instance.new("TextButton"); b.Size = UDim2.new(0.3, 0, 0.8, 0); b.Position = UDim2.new(0.02 + (count * 0.32), 0, 0, 0); b.Text = mode; b.Font = Enum.Font.Code; b.TextSize = 10; b.BorderSizePixel = 0; b.Parent = btnFrame
        buttons[mode] = b
...
MinSquare.Size = UDim2.new(0, 40, 0, 40); MinSquare.Position = UDim2.new(0.02, 0, 0.2, 0); MinSquare.BackgroundColor3 = _G.MenuColor; MinSquare.Text = "OH"; MinSquare.Font = Enum.Font.Code; MinSquare.TextColor3 = Color3.fromRGB(0, 0, 0); MinSquare.Visible = false; MinSquare.Draggable = true; MinSquare.Parent = ScreenGui
